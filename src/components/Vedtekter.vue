  ...
  <div class="bg-white">
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      <div class="w-full mt-4 text-center">
        <p class="text-[22px]">Vedtekter</p>
      <ol>
        <li>1. Neste vinsmaking skal settes i kalenderen</li>
        <li>2. Minst 2 medlemmer må være tilstede. Gjester er alltid velkommen!</li>
        <li>3. Karakterer settes objektivt via 100 skalaen</li>
      </ol>
      </div>
